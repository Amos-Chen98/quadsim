classdef QuadPlot < handle
    ...
    properties (SetAccess = private)
        h_3d
        h_m12;  % motor 1 and 2 handle
        h_m34;  % motor 3 and 4 handle
        h_m13;
        h_m24;
    ...
    methods
        ...
        function Q = QuadPlot(qn, state, wingspan, height, color, max_iter, h_3d)
            ...
            Q.h_3d = h_3d;
            hold(Q.h_3d, 'on')
            Q.h_pos_hist = plot3(Q.h_3d, Q.state(1), Q.state(2), Q.state(3), 'r','LineWidth',2);
            Q.h_pos_des_hist = plot3(Q.h_3d, Q.des_state(1), Q.des_state(2), Q.des_state(3), 'r','LineWidth',2);
            Q.h_m12 = plot3(Q.h_3d, ...
                Q.motor(1,[1 2]), ...
                Q.motor(2,[1 2]), ...
                Q.motor(3,[1 2]), ...
                'ko', 'MarkerFaceColor', Q.color, 'MarkerSize', 5);
            Q.h_m34 = plot3(Q.h_3d, ...
                Q.motor(1,[3 4]), ...
                Q.motor(2,[3 4]), ...
                Q.motor(3,[3 4]), ...
            ...
            if Q.qn == 1
                Q.h_qn = text(Q.h_3d,...
                    ...
                    Q.motor(3,5) + Q.text_dist, 'red');
            else
                Q.h_qn = text(Q.h_3d,...
                    Q.motor(1,5) + Q.text_dist, ...
                    Q.motor(2,5) + Q.text_dist, ...
                    Q.motor(3,5) + Q.text_dist, 'blue');
            end
            hold(Q.h_3d, 'off')
        end
