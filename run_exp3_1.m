...
figure;
for i = 1:5:size(t,1)
    scatter(quad1.position(i,1),quad1.position(i,2),'r'); hold on;
    scatter(quad2.position(i,1),quad2.position(i,2),'g'); hold on;
    scatter(quad3.position(i,1),quad3.position(i,2),'b'); hold on;
    axis equal;
